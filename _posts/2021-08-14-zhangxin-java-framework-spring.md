...
### The Design of IOC Container (Bean Factory)
...
public interface BeanFactory {
    ...
    * 1. A mapping between a bean type to a set of bean names, Map<Class, Set<String>>
...
### From Bean Definition Config To Dependency Ingestion Complete
